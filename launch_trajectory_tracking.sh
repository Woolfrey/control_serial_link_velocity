...
gnome-terminal -- bash -c "ros2 launch serial_link_velocity_control trajectory_tracking.py model:=${MODEL}; exec bash"
...
ros2 run serial_link_action_client trajectory_tracking_client \
  --ros-args \
  --params-file "${CONFIG_DIR}/${MODEL}/endpoint_poses.yaml" \
